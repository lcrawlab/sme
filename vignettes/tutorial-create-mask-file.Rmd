...
The Multimodal Marginal Epistasis test (MME) requires a HDF5 file containing
...
<img src="../reference/figures/mme-schematic-dhs.png"
width="100%"
alt="Multimodal Marginal Epistasis test (MME) schematic DHS data" />
...
The `mme()` function expects the mask data to be in an HDF5 file. The HDF5
...
subroutine in
`mme()`, which uses zero-based indexing, unlike R's one-based indexing for SNP
