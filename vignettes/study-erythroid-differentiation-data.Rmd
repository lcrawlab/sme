...
We apply MME to hematology traits of white British individuals from the
...
how to create a mask file for `mme()`. 
...
marginal epistasis with MME we consider the variants in the DHS regions
important.
...
With this mask file we can run MME.
...
**Figure 1.** Manhattan plot of the MME analysis. The dashed blue line is the
...
A total of five SNPs which MME significantly associates
...
Fitting the linear mixed model of MME also produces narrow-sense heritability
estimates equivalent to RHE regression. The heritability
estimates of MME for the four traits in this study are similar
...
|	MCHC      | 0.14 (0.01) |
|	MCV       | 0.52 (0.03) |
**Table 2.** Narrow-sense heritability ($h^2$) estimates in the MME analysis.

# References
- Stamp J, Pattilo-Smith S, Weinreich D & Crawford L (2024). Integration of 
  functional genomic maps enables genome-wide detection of
  epistasis in human complex traits. bioRXiv.
