...
The `mmer` package implements a computationally and statistically efficient method 
...
[Multimodal Marginal Epistasis test Documentation](https://lcrawlab.github.io/mmer/).
...
You can install the development version of mmer from [GitHub](https://github.com/) 
with:
...
[DESCRIPTION file](https://github.com/lcrawlab/mmer/blob/main/DESCRIPTION).
